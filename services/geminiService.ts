...
1. שיקוף קצר ונרמול (Validation): תאר ב-2-3 משפטים מה עובר עליו כרגע (מחטף אמיגדלה) בהתאם לסגנון שלו.
2. פעולה מיידית לוויסות: הצעה אחת קונקרטית לעצירת ההצפה (נשימה, יציאה מהחדר, השהיה).
3. המלצות "תכלס" לפעולה: 2-3 צעדים פרקטיים וממוקדים מאוד מה לעשות עכשיו כדי להתקדם, תוך התחשבות בסגנון שלו ובסיטואציה.
כתוב בצורה ישירה, תומכת וממוקדת מטרה, בפורמט Markdown ברור. המנע מניתוח ארוך.`;
