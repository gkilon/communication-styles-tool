...
אל תזכיר שאתה מודל שפה או AI. דבר כמאמן מומחה.
    ...
    try {
      ...
      const fallback = `היי! פרופיל התקשורת שלך מראה איזון מעניין בין כל ארבעת הצבעים. כדי לתת לך המלצה מדויקת, ספר לי בבקשה מה המצב איתו אתה רוצה עזרה (לדוגמה: "איך לנהל צוות?", "איך להציג רעיון למנהל שלי?")`;
      return {
        statusCode: 200,
        headers: { 'Content-Type': 'application/json' },
